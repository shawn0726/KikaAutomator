...
class LanguageSettingPage(BaseFunction):
    ...
    _open_menu_search_box = (By.ID, 'com.kika.photon.inputmethod:id/menu_search_view')
    _close_menu_search_box = (By.ID, 'com.kika.photon.inputmethod:id/toolbar_close')
    ...
    def open_input_menu_search(self, text):
        ...
        self.driver.find_element_by_id('com.kika.photon.inputmethod:id/toolbar_search').send_keys(text)
        time.sleep(3)
    ...
    def add_language_list(self, language, predict):
        # 列表方式
        # mlist = self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/iv_add')
        # print(mlist)
        # print(type(mlist))
        # self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/iv_add')[8].click()
        # 传入语言
        ...
        time.sleep(2)
        # 返回词典列表
        readtext = os.popen('adb shell "cd /data/data/com.kika.photon.inputmethod/files/dictServer && ls"')
    ...
    def add_language_list2(self, language, predict):
        language_list_bounds = self.container_bounds('list_view', 'resource_id')
        continue_swipe = True
        ...
        time.sleep(2)
        # 返回词典列表
        readtext = os.popen('adb shell "su -c cd /data/data/com.kika.photon.inputmethod/files/dictServer && ls"')
        dictext = readtext.read()
        readtext.close()
        # print(dictext)
        print(dictext.strip().split('\n'))
    ...
    def del_language_list(self, language):
        # 取消勾选按序号从上到下 0开始
        mlist = self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/cb_lang')
        print(mlist)
        self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/cb_lang')[0].click()
        # 取消语言列表第一个勾选
    ...
    def update_layout(self, layouttext1):
        mlist = self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/tv_layout')
        print(mlist)
        self.driver.find_elements_by_id('com.kika.photon.inputmethod:id/tv_layout')[0].click()
        # layouttext1为设置布局
        try:
    ...
    def updata_layout2(self, language, which_one):
        self.driver.find_element_by_xpath(
            '//*[@text="%s"]/../following-sibling::android.widget.LinearLayout/android.widget.LinearLayout/'
